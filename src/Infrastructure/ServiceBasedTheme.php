...
use MWPD\MwpdTheme\Infrastructure\ServiceContainer\LazilyInstantiatedService;
 ...
 */
abstract class ServiceBasedTheme implements Theme {
	...
	protected const REGISTRATION_ACTION = 'after_setup_theme';
